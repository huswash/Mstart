	...
	<tr>
		...
		<td width="100%" align="left" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
					<td width="14%" align="left" valign="top" class="admin">&nbsp;Class   : <?php echo classname($es_class); ?></td>
				...
				<tr>
					<td colspan="4" align="left" valign="top">
					  ...
					  <tr>
					  	<td align="left" class="admin">Lunch (3) </td>
					  	<td width="14%" colspan="-1" align="left" class="admin">Time Duration</td>
					  	<td width="28%" align="left" class="narmal">
...
?>					
					<table width="100%" height="262" border="1" cellpadding="5" cellspacing="0">
                      <tr  class="bgcolor_02"><?php $ttimage = str_replace("css", "", $_SESSION['eschools']['user_theme']);?>
						...
						?> </strong></td>
						<?php if($break_position==1) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==1) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
						
                        <td width="10%"align="center"><strong>2<?php print "<br>".$peried_2s." TO <br>".$peried_2e; ?></strong></td>
						<?php if($break_position==2) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==2) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
						
						 <!--<td width="10%"align="center"><strong> ---- </strong></td> -->
                        <td width="15%" align="center"><strong>3<?php print "<br>".$peried_3s." TO <br>".$peried_3e; ?></strong></td>
						<?php if($break_position==3) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==3) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
						
                        <?php if($number_of_periods >= 4) { ?><td width="17%" align="center"><strong>4<?php print "<br>".$peried_4s." TO <br>".$peried_4e; ?> </strong></td><?php }?>
						<?php if($break_position==4) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==4) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
						
                        <?php if($number_of_periods >= 5) { ?><td width="14%"align="center"><strong>5<?php print "<br>".$peried_5s." TO <br>".$peried_5e; ?></strong></td><?php }?>
						<?php if($break_position==5) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==5) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
						
						 
						<?php if($number_of_periods >= 6) { ?><td width="14%"align="center"><strong>6<?php print "<br>".$peried_6s." TO <br>".$peried_6e; ?></strong></td><?php }?>
						<?php if($break_position==6) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==6) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
						
						<?php if($number_of_periods >= 7) { ?><td width="14%"align="center"><strong>7<?php print "<br>".$peried_7s." TO <br>".$peried_7e; ?></strong></td><?php }?>
						<?php if($break_position==7) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==7) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
					
						<?php if($number_of_periods >= 8) { ?><td width="14%"align="center"><strong>8<?php print "<br>".$peried_8s." TO <br>".$peried_8e; ?></strong></td><?php }?>
						<?php if($break_position==8) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==8) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
						
						<?php if($number_of_periods >= 9) { ?><td width="14%"align="center"><strong>9<?php print "<br>".$peried_9s." TO <br>".$peried_9e; ?></strong></td><?php }?>
						<?php if($break_position==9) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==9) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
						
						<?php if($number_of_periods >= 10) { ?><td width="14%"align="center"><strong>10<?php print "<br>".$peried_10s." TO <br>".$peried_10e; ?></strong></td><?php }?>
						<?php if($break_position==10) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==10) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
...
WHERE classid =".$es_class."
			...
			<!--<td width="14%"align="center"><strong>B </strong></td> -->
                 ...
                 <?php /*?> <table width="80%">
  <tr>
    <td valign="top"><table width="100%" height="82" border="1" cellpadding="0" cellspacing="0">
                        <tr height="25" class="bgcolor_02">
                  
                         <td width="22%" height="23" align="center"><strong>Faculty Name </strong></td>
                         <td width="22%" height="23" align="center"><strong>Short Name</strong></td>
                        ...
                        <tr>
                          ...
                          <td class="narmal" align="center"><?php echo $eachstaff['st_firstname']." ".$eachstaff['st_lastname'] ;?></td>
                          <td class="narmal" align="center"><?php echo $eachstaff['es_staffid']."-".substr($eachstaff['st_firstname'],0,3);	?></td>
    ...
    <td valign="top"><table width="100%" height="82" border="1" cellpadding="0" cellspacing="0">
						...
						foreach($classlist as $indclass) {//print_r($timetablemasterdetails); ?>
                        <tr>
                         
                          <td class="narmal" align="center"><?php echo $indclass['es_subjectname'];	?></td>
                          <td class="narmal" align="center"><?php echo $indclass['es_subjectid']."-".substr($indclass['es_subjectname'],0,3);	?></td>
                 ...
                 <!--Staff and Subject display End-->
				  ...
				  <?php /*?><tr>
				  <td colspan="4" align="center" valign="top"><?php if(isset($es_class) && $es_class!=''){ ?>
                     <table width="43%" border="1" align="center" cellpadding="0" cellspacing="0">				  
				  <tr  height="25">
					<td class="admin" align="center" >Subject</td>
					<td class="admin" align="center"><input type="text" name="new_subject" value="" /></td>
					<td class="admin" align="center"><input type="submit" name="submit_newsubject" value="Add New Subject" class="bgcolor_02" style="cursor:pointer;" /></td>												
				  </tr><?php */?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <?php if(isset($es_class) && $es_class!=""){ ?>
				 ...
				 if($break_position==5 || $lunch_position==5)
				  ...
				  <table width="100%" height="300" border="1" cellpadding="0" cellspacing="0">
                      <tr  class="bgcolor_02">
                        ...
                        <td width="7%" height="23" align="center"><strong>1<?php 
						$school_start_time_1=explode(":",$school_start_time); 
                        ...
                        <td width="7%"align="center"><strong>2<?php print "<br>".$peried_2s." TO <br>".$peried_2e; ?></strong></td>
						
						<?php if($break_position==2) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==2) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
						  
                          <td width="7%" align="center"><strong>3<?php print "<br>".$peried_3s." TO <br>".$peried_3e; ?></strong></td>
						  
						  <?php if($break_position==3) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==3) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
						<?php if($number_of_periods >= 4) { ?>
                        <td width="7%" align="center"><strong>4<?php print "<br>".$peried_4s." TO <br>".$peried_4e; ?></strong></td>
							<?php } ?>
						<?php if($break_position==4) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==4) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
						<?php if($number_of_periods >= 5) { ?>
                        <td width="7%"align="center"><strong>5<?php print "<br>".$peried_5s." TO <br>".$peried_5e; ?></strong></td>
							<?php } ?>
						<?php if($break_position==5) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						<?php if($lunch_position==5) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
								<?php if($number_of_periods >= 6) { ?>
						    <td width="7%"align="center"><strong>6<?php print "<br>".$peried_6s." TO <br>".$peried_6e; ?></strong></td>
							<?php } ?>
							<?php if($break_position==6) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						    <?php if($lunch_position==6) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
								<?php if($number_of_periods >= 7) { ?>
							    <td width="7%"align="center"><strong>7<?php print "<br>".$peried_7s." TO <br>".$peried_7e; ?></strong></td>
								<?php } ?>
								<?php if($break_position==7) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						        <?php if($lunch_position==7) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td>

						         <?php } ?>
								<?php if($number_of_periods >= 8) { ?>
							    <td width="7%"align="center"><strong>8<?php print "<br>".$peried_8s." TO <br>".$peried_8e; ?></strong></td>
								<?php } ?>
								<?php if($break_position==8) { ?><td width="10%" rowspan="7"align="center"><strong>B1</strong></td> <?php } ?>
						        <?php if($lunch_position==8) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
			    ...
			    <td width="7%"align="center"><strong>9<?php print "<br>".$peried_9s." TO <br>".$peried_9e; ?></strong></td>
									<?php } ?>
				...
				<?php if($lunch_position==9) { ?><td width="10%" rowspan="7"align="center"><strong>B2</strong></td> <?php } ?>
								    ...
								    <td width="7%"align="center"><strong>10<?php print "<br>".$peried_10s." TO <br>".$peried_10e; ?></strong></td>
									<?php } ?>
